...
const SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "bentonita", label: "Bentonită Ocnița", type: "textarea", placeholder: "Este activă? Test umflare / tixotropie? Cost extracție + activare? Rol realist în gletul mineral?" },
      { id: "bentonita_separare", label: "Bentonită — extracție separată", type: "textarea", placeholder: "Din ce sector se extrage? Cât de ușor se separă de calcar? Ce rezerve reale și ce continuitate pe lot există?" },
      { id: "bentonita_fina", label: "Bentonită — uscare / micronizare", type: "textarea", placeholder: "Avem capacitatea să o uscăm și să o măcinăm foarte fin? Ce finete țintă? Ce echipament există sau lipsește?" },
      { id: "bentonita_aplicatii", label: "Bentonită — aplicații validate", type: "textarea", placeholder: "Poate intra 5-10% în glet? Există date pentru hidroizolații, filler tehnic, foraj sau adezivi economici?" },
    ],
  },
  {
    ...
    fields: [
      ...
      { id: "transfer_price", label: "Preț intern de transfer", type: "textarea", placeholder: "Cost extracție azi: 80-100 lei/t? Vânzare vrac: 250 lei/t? Pentru RENOVIT, la ce preț intern vom prelua Volodeni, Ocnița și bentonita?" },
  ...
  },
  {
    ...
    fields: [
      { id: "glet", label: "Glet mineral de bază 20kg", type: "textarea", placeholder: "Mix Ocnita + Volodeni + bentonita. Confirmă alb, volum, finete, cost, rolul bentonitei și necesarul minim de aditivi." },
      { id: "granule", label: "Granule decorative selectate 25kg", type: "textarea", placeholder: "Fracții, culoare, constanță, praf rezidual, produs comparabil, ambalare." },
      { id: "filler", label: "Filler micronizat alb 25kg / vrac", type: "textarea", placeholder: "PSD țintă, alb, cost micronizare, clase standard vs premium, clienți B2B." },
      { id: "retete", label: "Cine poate formula / testa rețetele?", type: "textarea", placeholder: "Laborator, tehnolog, consultant; pentru filler și granule contează mai ales PSD, alb și lot consistency; pentru glet contează și validarea bentonitei" },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "sortare", label: "Sortare granulometrică", type: "textarea", placeholder: "Site, separatoare, fracții pentru granule decorative și clase de filler" },
      { id: "mixer", label: "Mixer + dozare aditivi", type: "textarea", placeholder: "Mixer existent? Dozatoare mici doar pentru glet sau produse pilot?" },
      { id: "bentonita_proc", label: "Uscare / micronizare bentonită", type: "textarea", placeholder: "Există flux separat pentru bentonită? Ce cost și ce finete putem obține?" },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "regula_transfer", label: "Regulă transfer pricing proiect", type: "textarea", placeholder: "Vom lucra la cost de extracție, cost + marjă internă sau preț de piață / cost de oportunitate? Dacă extracția este 80-100 lei/t și vânzarea vrac 250 lei/t, la ce preț intern intră materia primă în RENOVIT?" },
      ...
      { id: "pret_granule", label: "Preț angro validat granule decorative", type: "textarea", placeholder: "Distribuitor sau B2B, preț, fracție, volum, condiții, produs comparabil" },
      { id: "pret_filler", label: "Preț angro validat filler micronizat", type: "textarea", placeholder: "Client B2B, preț per sac / tonă, PSD, alb, volum, condiții" },
      { id: "pret_bentonita", label: "Preț / interes bentonită tehnică", type: "textarea", placeholder: "Există clienți sau benchmarkuri pentru bentonită ca produs separat, filler tehnic sau aditiv mineral?" },
