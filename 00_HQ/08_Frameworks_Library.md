...
linked_decisions: []
open_questions:
  - Ce alte framework-uri vrem sa adoptam explicit si unde le mapam?
next_action: Foloseste aceasta nota ca index central pentru toate framework-urile adoptate in vault.
---
...
Aceasta este biblioteca centrala de framework-uri pentru RENOVIT.

Niciun framework nu ramane doar inspiratie.

El trebuie tradus in:
