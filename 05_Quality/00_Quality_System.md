...
linked_decisions: []
open_questions:
  - Care sunt pragurile reale pe care le poate sustine materia prima din Edinet?
...
1. Cerem analiza de laborator si detaliile de prelevare.
2. Comparam rezultatele cu `working thresholds`, fara sa confundam asta cu standardul UE.
3. Alegem produsul initial tinta pe baza compozitiei reale.
4. Mapam produsul final la standardul armonizat relevant si la traseul de conformitate.
...
- `Product route`: tencuiala, glet, placi sau alta ruta.
